...
def get_context():
	...
	if not check_app_permission():
		...
		brand = frappe.db.get_single_value("FCRM Settings", "brand_name") or "CRM"
		frappe.throw(_("You do not have permission to access {0}").format(brand), frappe.PermissionError)
